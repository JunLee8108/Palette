...
public struct PaletteSwatch: Identifiable, Hashable, Sendable {
    public let id: String
    public let hex: String

    public init(id: String, hex: String) {
        self.id = id
        self.hex = hex
    }
...
public enum DefaultPalette {
    public static let id = "default_v1"

    public static let swatches: [PaletteSwatch] = [
